...
function showWeather(weatherCondition){
    ...
    {
        case 'unknown':
            earth.className = "earthclear"
            break;
        case 'clear':
            earth.className = "earthclear"
            break;
        case 'rainy':
            earth.className = "earthrainy"
            break;
        case 'stormy':
            earth.className = "earthrainy"
            break;
        case 'snowy':
            earth.className = "earthsnowy"
            break;
        case 'partly cloudy':
            earth.className = "earthrainy"
            break;
...
//endregion
    ...
    //to do:
    //achtergrond veranderen naar blauwe hemel (zorgen dat deze aanpasbaar zijn adhv van weer
    //toevoegen van stelling aan begin
    //toevoegen raketten aan spaceshuttle
    //raketten losmaken bij opstijgen


    //sputnik passeren en tekst tonen

    //man en aap in ruimte passeren

    //maanlanding passeren (raket landt niet meer op maan)

    //ruimtestation passeren

    //mars passeert

    //landing op mars (raket vliegt uit scherm en marssurface beweegt in het scherm van vanonderen uit)
